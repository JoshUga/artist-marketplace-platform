...
class Artist(Base):
    ...
    portfolio_template_key = Column(String(64), nullable=False, default="editorial")
    portfolio_theme_name = Column(String(120), nullable=False, default="Warm Studio")
    portfolio_theme_config = Column(Text, nullable=True)
